...
import { School, Monitor, Fold, Expand, ArrowDown, Calendar, DataLine } from '@element-plus/icons-vue'
...
const handleSaveProfile = async () => {
  ...
  try {
    ...
    const response = await axios.put('/api/student/profile', {
      ...
      status: profileInfo.value.status
    })
...
const fetchProfileInfo = async () => {
  try {
    ...
    const response = await axios.get(`/api/student/students/${userId}`)
...
const handleChangePassword = async () => {
  ...
  try {
    ...
    const response = await axios.put('/api/student/password', {
