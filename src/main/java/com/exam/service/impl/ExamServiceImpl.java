...
public class ExamServiceImpl implements ExamService {
    ...
    @Override
    @CacheEvict(value = {"exam", "exam_list", "exam_by_teacher","class_by_teacher"}, allEntries = true)
    ...
    @Override
    @CacheEvict(value = {"exam", "exam_list", "exam_by_status","exam_by_teacher"}, allEntries = true)
