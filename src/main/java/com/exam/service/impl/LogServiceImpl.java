...
public class LogServiceImpl implements LogService {
    ...
    public List<Log> selectByCondition(Map<String, Object> condition) {
        ...
        return logMapper.selectByConditions(userId, actionType, objectType, startTime, endTime, status, null, null);
    }
    ...
    public List<Log> selectPageByCondition(Map<String, Object> condition, Integer pageNum, Integer pageSize) {
        ...
        Date endTime = (Date) condition.get("endTime");
        String status = (String) condition.get("status");
        return logMapper.selectByConditions(userId, actionType, objectType, startTime, endTime, status, offset, pageSize);
    }
